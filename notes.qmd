...
[OpenStreetMap](https://www.openstreetmap.org/) data is (C) OpenStreetMap Contributors. [OpenSeaMap](https://map.openseamap.org) ([description](https://map.openseamap.org/legend.php?lang=en&page=help-website)) uses data from OpenStreetMap and other sources.
...
https://pacificdata.org/data/dataset/global-distribution-of-coral-reefs
...
Data download <https://coralreefwatch.noaa.gov/product/vs/data/fiji.txt>
...
URL: https://stats-sdmx-disseminate.pacificdata.org/rest/data/SPC,DF_SDG,3.0/..FJ........?dimensionAtObservation=AllDimensions&format=csv

Dataset description:
This is a subset of Sustainable Development Goals (all) Contains available data on Pacific Sustainable Development Indicators selected by the region and endorsed by Forum Leaders in the...
Source: SDG country package for Fiji


Identifier	DV_SDG_FJ
Modified	2024-05-03
DCAT Type	Dataset
Source	https://stats.pacificdata.org/vis?dq=A..FJ._T._T._T._T._T._T._Z._T&pd=2010%2C&frequency=A&lc=en&df[ds]=SPC2&df[id]=DF_SDG&df[ag]=SPC&df[vs]=3.0
Publisher Name	SPC

https://stats.pacificdata.org/vis?dq=A..FJ._T._T._T._T._T._T._Z._T&pd=2010%2C&frequency=A&lc=en&df[ds]=SPC2&df[id]=DF_SDG&df[ag]=SPC&df[vs]=3.0&ly[rs]=INDICATOR&ly[rw]=GEO_PICT%2CTIME_PERIOD&to[TIME_PERIOD]=false&lb=bt
...
Data portal looks interesting: https://population.un.org/dataportal/ (but it's slow / didn't return data in some cases)

Referenced from https://database.earth/population/fiji

https://population.un.org/wpp/Download/Standard/MostUsed/ downloaded 2024-06-21
