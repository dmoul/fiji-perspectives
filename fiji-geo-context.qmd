...
The Fiji Islands are so small and remote from the major continents that they are often omitted from world maps, or when they are included, relegated to the edges of the map, since Fiji island land masses are just west and east of 180°:
...
Most visitors coming for a holiday to Fiji fly into Nadi airport on the western side of Viti Levu and stay nearby, since this area generally has the best weather, picturesque South Seas islands, and is easily accessible. The Mamanucas are the island group closest to Nadi, further north are the Yasawas.
...
```{r}
#| label: define-osm-gebco-map-data
...
ggplot() +
  geom_spatraster_contour_filled(data = fj_bath_spatraster |>
                          ...
                          # breaks = c(1, 5, 10, 15, 20, 25, 50, 75, 150, 300, 1000, 2000, 3000),
                          , alpha = plot_alpha,
                          na.rm = TRUE) +
  ...
  guides(fill = guide_legend(reverse = FALSE,
                             position = "inside",
                             ncol = 2)) +
  theme(panel.background = element_rect(fill = "#F5DEB3"), # "#FFFACD99"), # Doesn't seem panel.background honors alpha suffix "99"
  ...
  labs(
    ...
    # subtitle = "and still may not be complete",
...
#| fig-cap: "Western Fiji including the Yasawa islands^[Western Fiji including the Yasawa islands Land Information NZ July 2020 NZ 14638 Fiji to Kermadec Islands including Tongatapu INT number 638 Scale 1 to 1500000 TODO: add link here ]"
#| fig-width: 10
#| column: page-right
